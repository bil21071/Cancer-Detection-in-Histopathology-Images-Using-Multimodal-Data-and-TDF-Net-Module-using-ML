...
# Create the directory if it doesn't exist
    if not os.path.exists(save_weights_dir):
        ...
        torch.save(model.state_dict(), os.path.join(save_weights_dir, "best_model.pth"))
    ...
    for epoch in range(epochs):
        ...
        if valid_accuracy_avg >= best_model:
            torch.save(model.state_dict(), "C:/Users/Hp/Downloads/TDF_Net/TDF_Net/save_weights/best_model.pth")
